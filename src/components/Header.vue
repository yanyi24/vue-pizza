<template>
  <header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <ul class="navbar-nav">
        <!-- <li><router-link :to="homeLink" class="nav-link" tag="div">主页</router-link></li> -->
        ...
        <li><router-link to="/translate" class="nav-link">在线翻译</router-link></li>
      </ul>
      <ul class="navbar-nav ml-auto">
        <li><router-link to="/login" v-show="!isLogin" class="nav-link">登陆</router-link></li>
